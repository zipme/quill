...
var scroll_1 = __webpack_require__(53);
...
var _clipboard = __webpack_require__(61);
  ...
  bindings: {
    ...
    'indent table': {
      ...
      handler: function handler(range) {
        var TableCell = _parchment2.default.query('table-cell');
        var index = range.index;

        var _quill$scroll$descend = this.quill.scroll.descendant(TableCell, index),
            _quill$scroll$descend2 = _slicedToArray(_quill$scroll$descend, 1),
            cell = _quill$scroll$descend2[0];

        if (!cell) return;

        var nextCellIndex = void 0;
        ...
        if (cell.next) {
          ...
          if (nextRow) {
            var firstCell = nextRow.children.head;
        ...
        this.quill.setSelection(nextCellIndex, selectionLength, _quill2.default.sources.SILENT);
      }
    },
    'outdent table': {
      key: Keyboard.keys.TAB,
      ...
      handler: function handler(range) {
        ...
        var _quill$scroll$descend3 = this.quill.scroll.descendant(TableCell, index),
            _quill$scroll$descend4 = _slicedToArray(_quill$scroll$descend3, 1),
            cell = _quill$scroll$descend4[0];
        ...
        if (cell.prev) {
          ...
          if (prevRow) {
            var lastCell = prevRow.children.tail;
        ...
        this.quill.setSelection(prevCellIndex, selectionLength, _quill2.default.sources.SILENT);
      }
    },
    'remove tab': {
      key: Keyboard.keys.TAB,
...
function makeCodeBlockHandler(indent) {
  return {
    ...
    handler: function handler(range) {
      ...
      var _quill$scroll$descend5 = this.quill.scroll.descendant(CodeBlock, index),
          _quill$scroll$descend6 = _slicedToArray(_quill$scroll$descend5, 2),
          block = _quill$scroll$descend6[0],
          offset = _quill$scroll$descend6[1];
...
module.exports = {
  'align': {
    ...
    'center': __webpack_require__(69),
    'right': __webpack_require__(72),
    'justify': __webpack_require__(70)
  },
  ...
  'list': {
    ...
    'bullet': __webpack_require__(92),
    'check': __webpack_require__(93)
  },
  'script': {
    'sub': __webpack_require__(97),
    'super': __webpack_require__(98)
  },
  'strike': __webpack_require__(96),
  'table': __webpack_require__(101),
  'table-insert-rows': __webpack_require__(100),
  'table-insert-columns': __webpack_require__(99),
...
var getClosestNewLineIndex = function getClosestNewLineIndex(contents, index) {
...
Toolbar.DEFAULTS = {
  ...
  handlers: {
    ...
    table: function table() {
      ...
      var range = this.quill.getSelection();
      if (!range) return;
      var newLineIndex = getClosestNewLineIndex(this.quill.getContents(), range.index + range.length);
      var changeDelta = new _quillDelta2.default().retain(newLineIndex);
      changeDelta = changeDelta.insert('\n');
      var tableId = 'table-' + Math.random().toString(36).slice(2);
      for (var i = 0; i < rows; i++) {
        var rowId = 'row-' + Math.random().toString(36).slice(2);
        for (var j = 0; j < columns; j++) {
          var cellId = 'cell-' + Math.random().toString(36).slice(2);
    ...
    'table-insert-rows': function tableInsertRows() {
      var _quill$getSelection = this.quill.getSelection(),
          index = _quill$getSelection.index;

      var _quill$getLine = this.quill.getLine(index),
      ...
      if (!row) return;
      var tableId = row.formats()['table-row'].tableId;


      var newRowId = 'row-' + Math.random().toString(36).slice(2);
      var table = row.parent;
      for (var i = 0; i < row.children.length; i++) {
        var newCellId = 'cell-' + Math.random().toString(36).slice(2);
        var cell = _parchment2.default.create('table-cell', { tableId: tableId, rowId: newRowId, cellId: newCellId });
        table.insertBefore(cell, row);
      }
    },
    'table-insert-columns': function tableInsertColumns() {
      var _quill$getSelection2 = this.quill.getSelection(),
          index = _quill$getSelection2.index;

      var _quill$getLine3 = this.quill.getLine(index),
          _quill$getLine4 = _slicedToArray(_quill$getLine3, 1),
          line = _quill$getLine4[0];
      ...
      if (!cell) return;
      var _cell$formats$tableC = cell.formats()['table-cell'],
          tableId = _cell$formats$tableC.tableId,
          cellId = _cell$formats$tableC.cellId;

      var place = 0;
      var currentCell = cell.parent.children.head;
      var currentCellId = currentCell.formats()['table-cell'].cellId;
      ...
      for (var i = 0, row = rows.head; i < rows.length; i += 1, row = row.next) {
        var refCell = row.children.head;
        for (var j = 0; j < place; j++) {
          refCell = refCell.next;
        }

        var newCellId = 'cell-' + Math.random().toString(36).slice(2);
        var currentRowId = row.formats()['table-row'].rowId;

        var newCell = _parchment2.default.create('table-cell', { tableId: tableId, rowId: currentRowId, cellId: newCellId });
...
var _colorPicker = __webpack_require__(64);

var _colorPicker2 = _interopRequireDefault(_colorPicker);

var _iconPicker = __webpack_require__(65);
...
var _indent = __webpack_require__(107);
...
var _bold = __webpack_require__(60);

var _bold2 = _interopRequireDefault(_bold);

var _italic = __webpack_require__(108);
...
var _script = __webpack_require__(110);

var _script2 = _interopRequireDefault(_script);

var _strike = __webpack_require__(111);

var _strike2 = _interopRequireDefault(_strike);

var _underline = __webpack_require__(113);
...
var _image = __webpack_require__(106);
...
var _formula = __webpack_require__(115);

var _formula2 = _interopRequireDefault(_formula);

var _syntax = __webpack_require__(116);
...
var _bubble = __webpack_require__(117);

var _bubble2 = _interopRequireDefault(_bubble);

var _snow = __webpack_require__(68);
...
_core2.default.register({
  ...
  'formats/table': _table2.default,
  'formats/table-row': _table.TableRow,
  'formats/table-cell': _table.TableCell,
...
module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"ql-fill ql-transparent\"> <rect height=10 rx=1 ry=1 width=4 x=12 y=2></rect> <rect height=10 rx=1 ry=1 width=4 x=2 y=2></rect> </g> <path class=ql-fill d=M11.354,4.146l-2-2a0.5,0.5,0,0,0-.707,0l-2,2A0.5,0.5,0,0,0,7,5H8V6a1,1,0,0,0,2,0V5h1A0.5,0.5,0,0,0,11.354,4.146Z></path> <rect class=ql-fill height=8 rx=1 ry=1 width=4 x=7 y=8></rect> </svg>";

/***/ }),
/* 100 */
/***/ (function(module, exports) {

module.exports = "<svg viewbox=\"0 0 18 18\"> <g class=\"ql-fill ql-stroke ql-thin ql-transparent\"> <rect height=3 rx=0.5 ry=0.5 width=7 x=4.5 y=2.5></rect> <rect height=3 rx=0.5 ry=0.5 width=7 x=4.5 y=12.5></rect> </g> <rect class=\"ql-fill ql-stroke ql-thin\" height=3 rx=0.5 ry=0.5 width=7 x=8.5 y=7.5></rect> <polygon class=\"ql-fill ql-stroke ql-thin\" points=\"4.5 11 2.5 9 4.5 7 4.5 11\"></polygon> <line class=ql-stroke x1=6 x2=4 y1=9 y2=9></line> </svg>";
...
exports.default = exports.TableRow = exports.TableCell = undefined;
  ...
  _createClass(TableCell, [{
    ...
    value: function optimize() {
      ...
      if (this.parent && this.parent.statics.blotName !== 'table-row') {
        var row = _parchment2.default.create('table-row', this.statics.formats(this.domNode));
...
TableCell.scope = _parchment2.default.Scope.BLOCK_BLOT;
TableCell.defaultChild = 'block';
TableCell.allowedChildren = [_block2.default, _block.BlockEmbed, _container2.default, _break2.default];
  ...
  _createClass(TableRow, [{
    ...
    value: function optimize() {
      ...
      if (this.parent && this.parent.statics.blotName !== 'table') {
        var row = _parchment2.default.create('table', this.statics.formats(this.domNode));
        this.parent.insertBefore(row, this);
        row.appendChild(this);
      }
    }
...
TableRow.tagName = 'TR';
TableRow.scope = _parchment2.default.Scope.BLOCK_BLOT;
TableRow.defaultChild = 'table-cell';
TableRow.allowedChildren = [TableCell, _block2.default, _block.BlockEmbed, _container2.default, _break2.default];
...
Table.scope = _parchment2.default.Scope.BLOCK_BLOT;
Table.tagName = 'TABLE';
Table.defaultChild = 'table-row';
Table.allowedChildren = [TableRow, TableCell, _block2.default, _block.BlockEmbed, _container2.default, _break2.default];
...
var _quill = __webpack_require__(67);
